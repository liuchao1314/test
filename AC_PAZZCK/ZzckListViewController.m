...
#import "ZzckListViewController.h"
#import "UserInfo.h"
#import "TaskCell.h"
#import "ZzckStore.h"
#import "TaskFlow.h"
...
@interface ZzckListViewController ()

@end

@implementation ZzckListViewController
...
- (IBAction)cellButtonTapped:(id)sender {
    ...
    [[CurrentTaskInfo currentTaskInfo] setTaskInfo:[[[ZzckStore zzckStore] flowList] objectAtIndex:indexPath.row]];
    
    if ([[[[[ZzckStore zzckStore] flowList] objectAtIndex:indexPath.row] taskFlowdic] objectForKey:@"zzck"]==nil) {
        [[AcModule sharedModule] setForegroundViewController:self];
        [[TaskService taskService] createTaskFlowWith:[[[[ZzckStore zzckStore] flowList] objectAtIndex:indexPath.row] taskID] taskflowtype:@"VIP查勘" caseType:@"双方事故"];
    }else{
        [[CurrentTaskFlow currentTaskFlow] setTaskFlow:[[[[CurrentTaskInfo currentTaskInfo] taskInfo] taskFlowdic] objectForKey:@"zzck"]];
        ;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[[ZzckStore zzckStore] flowList] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TaskInfo* task=[[[ZzckStore zzckStore] flowList] objectAtIndex:indexPath.row];
