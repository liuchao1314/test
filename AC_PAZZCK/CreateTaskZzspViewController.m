//
//  CreateTaskZzspViewController.m
//  AC_PAZZCK
//
...
#import "CreateTaskZzspViewController.h"
#import "TaskService.h"
@interface CreateTaskZzspViewController ()

@end

@implementation CreateTaskZzspViewController
@synthesize caseno;
@synthesize caseType;
...
- (IBAction)createTask:(id)sender {
    ...
    [[TaskService taskService] createTaskWith:self.caseno.text andTaskflowtype:@"VIP理赔" caseType:type];
